...
function filterByCondition(arr, condition) {
  return arr.filter(condition, arr);
...
function checkArray(obj) {
  if (obj == null || obj == undefined) {
    return console.log("Помилка: Вхідний об'єкт є null або undefined.");
...
function customIncludes(arr, element) {
  if (!Array.isArray(arr)) {
    ...
    const filtered = arr.filter((value, index, arr) => value === element);
    return console.log(filtered.length), arr.includes(element);
  } else {
    return 0;
  }
